...
function Newsarea() {
    ...
    useEffect(()=>{
        async function getNewsOverview(){
            const response = await fetch('http://localhost:8000/homepageData')
        ...
        <div className={styles.newsLeft}>
            ...
            <div className={styles.categoriesHeadlines}>
                ...
                <div className={styles.categoriesList}>
                    <span className={styles.category} id='indiaSmall' style={{borderTop: '#bbb 0.1px solid !important', borderBottom: '0 solid #000', borderRight: '#bbb 0.1px solid', borderLeft: '0.1px solid #bbb', fontWeight: 600}} onClick={()=>{homeCategory('india')}}>India</span>
        ...
        <div className={styles.newsRight}>
            <div className={styles.topHeadlinesDiv}>
                ...
                <div className={styles.topHeadlines}>
                    <Headline id='lh1' img={lh1img} title={lh1title} text={lh1text} />
                    <Headline id='lh2' img={lh2img} title={lh2title} text={lh2text} />
                    <Headline id='lh3' img={lh3img} title={lh3title} text={lh3text} />
                    <Headline id='lh4' img={lh4img} title={lh4title} text={lh4text} />
                    <Headline id='lh5' img={lh5img} title={lh5title} text={lh5text} />
                    <Headline id='lh6' img={lh6img} title={lh6title} text={lh6text} />
                    <Headline id='lh7' img={lh7img} title={lh7title} text={lh7text} />
                </div>
            </div>
